...
rule r2_merge_3_lanes_bams_markdup_PerChr_from_minimap2:
	...
	output:
		sampleschrBAMmarkdup = expand("results/AlternativeVariantCalling_DNA/2_merge_3_lanes_bams_markdup_PerChr/{sample}_merged.{{chr}}.bam", sample=config["samples"])
	log:
		err = "logs/AlternativeVariantCalling_DNA/2_merge_3_lanes_bams_markdup_PerChr/2_merge_3_lanes_bams_markdup_PerChr_{chr}.err",
		out = "logs/AlternativeVariantCalling_DNA/2_merge_3_lanes_bams_markdup_PerChr/2_merge_3_lanes_bams_markdup_PerChr_{chr}.out"
	benchmark:
		"benchmarks/AlternativeVariantCalling_DNA/{folder}/2_merge_3_lanes_bams_markdup_PerChr_{chr}_{round}.txt"
	conda:
		'../envs/VariantCalling_DNA.yaml'
	params:
		time = '15:00:00',
...
rule r3_base_recalibration_GATK_PerChr_PerSample_round2_from_minimap2:
	...
	input:
		...
		samplechrplatformBAM = "results/AlternativeVariantCalling_DNA/2_merge_3_lanes_bams_markdup_PerChr/{samplelaneplatform}_round1.{chr}.bam",
		genomeFA = "data/genomes/BraLan3/Branchiostoma_lanceolatum.BraLan3_genome.fa"
	output:
		BRecal = "results/AlternativeVariantCalling_DNA/3_base_recalibration_GATK_PerChr_round2/BaseRecalibration_GATK_{samplelaneplatform}_round2.{chr}.txt",
		samplechrplatformBAMRecal = "results/AlternativeVariantCalling_DNA/3_base_recalibration_GATK_PerChr_round3/{samplelaneplatform}_round2.{chr}.bam"
	log:
